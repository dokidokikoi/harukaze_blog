...
import { ICommentVo } from '@/api/types/comment'
import { onMounted, reactive, ref } from 'vue'
import PubComment from './PubComment/PubComment.vue'
...
const param = reactive<ICommonParam>({
  key: '',
  page: 1,
  limit: 5
})

const commentList = ref<ICommentVo[]>([])
